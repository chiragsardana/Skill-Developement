...
public class Q6
{
	...
	{
		Scanner input=new Scanner(System.in);//Priority Queue based on min heap
...
//		 pqueue.add(t.addTask("Driving",2));			Chirag19CSU071
...
//		 System.out.println("The Element with highest Priority : "+pqueue.poll());
//		 System.out.println("The Element with highest Priority : "+pqueue.poll());
