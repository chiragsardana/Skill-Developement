package Queue;
//Write a program to find the unique values in a circular queue.
public class UniqueCircularQueue {
...
//		queue.enqueue(new Integer(10));
		...
		System.out.print("The Unique Element in the Circular Queue : ");
		for(int i = 1;i<=queue.size();i++) {
